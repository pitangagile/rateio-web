  ...
  <b-row class="page">
    ...
    <b-col cols="12">
        ...
        <div slot="progress" slot-scope="props">
          <b-progress :value="props.row.progress * 100" :max="100" show-progress :class="getVariant(props.row.status)" class="user-progress"></b-progress>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      MOCK_users: [
        { picture: '/static/img/avatars/1.jpg', fullname: 'Jacqueline Sanders', career: 'Desenvolvedor', progress: 1, status: 'approved' },
        { picture: '/static/img/avatars/2.jpg', fullname: 'Brittany Bates', career: 'Testador', progress: 0.8, status: 'suspended' },
        { picture: '/static/img/avatars/3.jpg', fullname: 'Tamara Steward', career: 'Analista', progress: 0.9, status: 'blocked' },
        { picture: '/static/img/avatars/4.jpg', fullname: 'Arthur Rose', career: 'Testador', progress: 0.5, status: 'pending' },
        { picture: '/static/img/avatars/5.jpg', fullname: 'Yolanda Craig', career: 'Analista', progress: 1, status: 'approved' },
        { picture: '/static/img/avatars/6.jpg', fullname: 'Alvin Ward', career: 'Desenvolvedor', progress: 1, status: 'pending' },
        { picture: '/static/img/avatars/7.jpg', fullname: 'Meghan Garcia', career: 'Analista', progress: 0.7, status: 'suspended' },
        { picture: '/static/img/avatars/8.jpg', fullname: 'Terry Jordan', career: 'Desenvolvedor', progress: 1, status: 'approved' },
        { picture: '/static/img/avatars/9.jpg', fullname: 'Holly Schmidt', career: 'Testador', progress: 0.3, status: 'pending' },
        { picture: '/static/img/avatars/10.jpg', fullname: 'Clifton Burton', career: 'Desenvolvedor', progress: 0.63, status: 'pending' },
        { picture: '/static/img/avatars/11.jpg', fullname: 'John Douglas', career: 'Desenvolvedor', progress: 0.75, status: 'pending' },
        { picture: '/static/img/avatars/12.jpg', fullname: 'Tracey Diaz', career: 'Desenvolvedor', progress: 0.7, status: 'pending' },
      ],
    };
  },
  mounted() {
...
.page {
  ...
  /deep/ .VueTables__search {
    ...
    .VueTables__search-field { float: left; }
  }
  ...
  .user-status {
    ...
    &.danger { border-color: $color-danger; color: $color-danger; }
    &.warning { border-color: $color-warning; color: $color-warning; }
    &.info { border-color: $color-info; color: $color-info; }
  }
